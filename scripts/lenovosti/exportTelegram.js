function exportTelegram() {
	...
	//POST 1: Leader
		...
		if (leaderData.length > 0) {
			...
			//TODO reading time
			html = '<div><b>' + numberOfNewsToWord(globalNewsCounter) + ' за ' + calculateReadingTime(globalNewsCounter / 12 * 160) + '</b><br>';
	...
	//POST 3: Foreign
		//start new post
		html = '<div><b>Импортные леновости</b><br>Время московское, статьи английские';
